...
The backend Dockerfiles (`Dockerfile.backend`, `Dockerfile.dashboard`) and every patch under `patches/` modify or derive from Convex and are offered under the "Functional Source License, Version 1.1, Apache 2.0 Future License" (`FSL-1.1-Apache-2.0`), whose full terms follow. \
Images built from these files redistribute Convex under the FSL plus the licenses of their third-party components.

Upstream source: [github.com/get-convex/convex-backend](https://github.com/get-convex/convex-backend).
